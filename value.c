...
struct cee_vect * cee_json_to_array (struct cee_json * p) {
  if (p->t == is_array) {
...
void cee_json_array_append (struct cee_json * j, struct cee_json *v) {
  struct cee_vect * o = cee_json_to_array(j);
  if (!o) 
    cee_segfault();
  cee_vect_append(o, v);
}
...
void cee_json_array_append_bool (struct cee_json * j, bool b) {
  ...
  if (!o) 
    cee_segfault();
  cee_vect_append(o, cee_json_bool(b));
}
...
void cee_json_array_append_string (struct cee_json * j, char * x) {
  ...
  if (!o) 
    cee_segfault();
  cee_vect_append(o, cee_json_string(cee_str("%s", x)));
}
